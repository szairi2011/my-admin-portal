export const environment = {
  ...
  user_task_api_url: 'http://' + window.location.hostname + ':' + window.location.port + '/api/tasks/', // Proxying calls for containerized environments
  /*
  ...
  */
  ...
  user_info_api_url: 'http://' + window.location.hostname + ':' + window.location.port + '/api/users/' // Proxying calls for containerized environments
};
